...
public class Data {
    ...
    private static final String VALID_CHARACTERS="abcdefghijklmnopqrstuvwxyzABCDEGGHIJKLMNOPQRSTUVWXYZ0123456789_";
    ...
    public static boolean validate (String login,
        ...
        try{
            control(login, password, confirmPassword);
    ...
    private static void control (String login,
                                    String password,
